...
<head>
	...
	<link href="custombox/dist/custombox.min.css" rel="stylesheet">
	<link href="ella2.css" rel="stylesheet">
	...
	<div class="container" id="wrapper">
	    ...
	    <div id="modal" style="display: none;">
	    	...
	    	<div class="close" onclick="Custombox.modal.close();">+</div>
    	  	<form action="#" method="post" name="sign up for beta form" id="content">
		      	<div class="nl_header">
		         	<p>Sign Up For Our Newsletter</p>
		      	</div>
		      	<div class="nl_description">
		      		<span style="color: red; height: 20px"> <?php echo $redErr;?></span> <br>
		        	<p style="font-family: 'Lato', sans-serif; font-size: 20px">Select your location and enter your email to start receiving your Longs ad every Sunday!</p>
		      	</div>
